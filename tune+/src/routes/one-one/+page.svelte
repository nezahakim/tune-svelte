...
<main class="flex flex-col h-full w-full justify-between bg-gray-600">
    <div class="flex items-center justify-between w-full bg-gray-700 p-2 rounded-b-2xl">
        ...
        <a href="/home" class=" flex items-center py-1 px-3 gap-1 bg-amber-200 rounded-4xl">
        ...
        <div class="py-1 px-3 flex items-center bg-amber-100 rounded-4xl gap-2">
            <div class="flex items-center justify-end w-full">
                <span class="bg-white ml-1 rounded-full h-[20px] w-[4px] text-white"></span>
                <span class="bg-white ml-1 rounded-full h-[10px] w-[4px] text-white"></span>
                <span class="bg-white ml-1 rounded-full h-[20px] w-[4px] text-white"></span>
             </div>
            <span  class="text-[12px] font-bold flex gap-2">Neza<p class="text-amber-500">speaking...</p> </span>
        </div>

        <button class="flex items-center py-1 px-3 gap-1 backdrop-blur-2xl shadow-3xl rounded-4xl  bg-amber-100 ">
     ...
     <div class=" shadow-4xl flex flex-col h-full w-full">
        <div class=" h-full w-full flex flex-col items-center justify-center ">
            <div class="bg-gray-400 p-10 w-[90%] rounded-3xl flex flex-col items-center">
                <img class="w-[120px] h-[120px] rounded-full p-2 bg-white" src="/1.jpg" alt="IMG">
                <span class="p-2 font-bold text-[14px] text-white">Neza Hakim</span>
             </div> 
        </div>
        <div class=" h-full w-full flex flex-col items-center justify-center ">
            <div class="bg-gray-500 p-10 w-[90%] rounded-3xl flex flex-col items-center">
                <img class="w-[120px] h-[120px] rounded-full p-2 bg-white" src="/1.jpg" alt="IMG">
     ...
     <div class="rounded-t-2xl bg-gray-700 p-2 flex items-center justify-between">
         ...
         <ul class="flex items-center gap-2 ">
            <li class="py-2 bg-gray-300 px-3 rounded-2xl text-blue-500 "><button onclick={handleReact}><i class="fas fa-face-grin"></i></button></li>
            <li class="py-2 bg-gray-300 px-3 rounded-2xl text-blue-500 "><i class="fas fa-face-grin-beam-sweat"></i></li>
            <li class="py-2 bg-gray-300 px-3 rounded-2xl text-blue-500 "><i class="fas fa-face-grin-squint-tears"></i></li>
            <li class="py-2 bg-gray-300 px-3 rounded-2xl text-blue-500 "><i class="fas fa-heart"></i></li>
         </ul>

        <div class="text-[12px] gap-1 font-bold flex items-center bg-amber-200 p-2 rounded-2xl ">
...
{#if visible}
     <div class="w-full h-full absolute bottom-0 right-0 flex items-center justify-center backdrop-blur-[3px]" out:fade> 
        <i class="fas fa-face-grin text-9xl fa-sync fa-spin fa-bounce --fa-bounce-rebound fa-flip " transition:fade></i>
    </div>
{/if}
